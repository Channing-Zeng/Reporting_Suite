...
#	plot-vcfstats -s /Users/vladsaveliev/vagrant/variantannotation/work/S1_bcftools.report -p /Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/ --no-PDF
#
# Edit as necessary and recreate the plots by running
#	python /Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/plot.py 
#
# Title abbreviations:
# 	 0 .. S1 .. /Users/vladsaveliev/vagrant/variantannotation/work/S1.vcf.gz
#
...
dat = []
with open('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/tstv_by_qual.0.dat', 'rb') as f:
...
plt.title('S1')
plt.savefig('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/tstv_by_qual.0.png')
if pdf_plots: plt.savefig('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/tstv_by_qual.0.pdf')
plt.close()
...
plt.title('S1')
plt.savefig('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/indels.0.png')
if pdf_plots: plt.savefig('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/indels.0.pdf')
plt.close()
...
plt.title('S1')
plt.savefig('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/substitutions.0.png')
if pdf_plots: plt.savefig('/Users/vladsaveliev/vagrant/variantannotation/work/S1_qc_plots/substitutions.0.pdf')
plt.close()

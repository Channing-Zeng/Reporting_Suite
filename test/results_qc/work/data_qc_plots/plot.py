...
#	plot-vcfstats -s /Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_bcftools.report -p /Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/ --no-PDF
#
# Edit as necessary and recreate the plots by running
#	python /Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/plot.py 
#
# Title abbreviations:
...
dat = []
with open('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/tstv_by_qual.0.dat', 'rb') as f:
...
plt.title('sampl')
plt.savefig('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/tstv_by_qual.0.png')
if pdf_plots: plt.savefig('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/tstv_by_qual.0.pdf')
plt.close()
...
plt.title('sampl')
plt.savefig('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/indels.0.png')
if pdf_plots: plt.savefig('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/indels.0.pdf')
plt.close()
...
plt.title('sampl')
plt.savefig('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/substitutions.0.png')
if pdf_plots: plt.savefig('/Users/vladsaveliev/vagrant/ngs_analysis/test/results_qc/work/data_qc_plots/substitutions.0.pdf')
plt.close()

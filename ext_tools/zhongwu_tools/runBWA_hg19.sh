...
~/local/bwa-0.6.2/bwa aln -t 10 -k 2 -l 30 -n 4 -R 5 /users/kdld047/work/NGS/NGS/genomes/hg19/Sequence/BWAIndex/genome.fa $1 > ${3}_1.sai 2> 1err
~/local/bwa-0.6.2/bwa aln -t 10 -k 2 -l 30 -n 4 -R 5 /users/kdld047/work/NGS/NGS/genomes/hg19/Sequence/BWAIndex/genome.fa $2 > ${3}_2.sai 2> 2err
~/local/bwa-0.6.2/bwa sampe -P -r "@RG\tID:$3\tSM:$3" /users/kdld047/work/NGS/NGS/genomes/hg19/Sequence/BWAIndex/genome.fa ${3}_1.sai ${3}_2.sai $1 $2 > $3.sam 2> sampe.err 
...
samtools index ${3}_sorted_NoDup.bam

...
/users/kdld047/local/bwa-0.7.4/bwa mem -t 8 -P -c 20 -R "@RG\tID:$3\tSM:$3" /users/kdld047/work/NGS/NGS/genomes/hg19/Sequence/BWAIndex/genome.fa $1 $2 > $3.sam 2> bwa.err 

...
def main():
    ...
    parser.add_option('--runner', dest='qsub_runner', default=Defaults.qsub_runner, help='sh script for qsub that accepts command line as the 1st argument ' + Defaults.qsub_runner)

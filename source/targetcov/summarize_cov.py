...
def summary_reports(cnf, bcbio_structure):
    ...
    jsons_by_sample = bcbio_structure.find_targetcov_report_fpaths_by_sample('json')
    htmls_by_sample = bcbio_structure.find_targetcov_report_fpaths_by_sample('html')

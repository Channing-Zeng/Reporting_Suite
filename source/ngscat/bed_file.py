...
#################### NOT NEEDED IN DEFAULT ngsCAT! #########################
        ...
        #
        #
        # def __sub__(self, other, cnf=None):
        #     if not cnf:
        #         cnf = config.cnf
        #
        #     pid = str(os.getpid())
        #     newbed_fpath = join(cnf['tmp_dir'], pid + basename(self.filename)[:-len('.bed')]
        #                                         + '-' + basename(other.filename))
        ...
        #         fd.write(region[0] + '\t' + str(region[1] + startshift) + '\t' + str(region[2] + endshift) + '\t' + str(
        #             windows[region]) + '\n')
        #     fd.close()
        #
        ...
        #     sortedkeys = self.sortcountkeys(windows)
        #     for region in sortedkeys:
        #         fd.write('hs' + region[0] + ' ' + str(region[1] + startshift) + ' ' + str(region[2] + endshift) + ' ' + str(
        #             windows[region]) + '\n')
        #     fd.close()
        #
        # def my_sort_bed(self, cnf=None):
        #     """************************************************************************************************************************************************************
        #     JPFLORIDO
        ...
        #         cnf = config.cnf
        #
        #     newbedfilename = intermediate_fname(cnf['tmp_dir'], self.filename, 'sorted')
        #
        ...
        #
        #     if (fileout == None):
        #         newbed = bed_file(TMP + '/' + pid + os.path.basename(self.filename)[:-4] + '_intersect_' + os.path.basename(
        #             other.filename))
        #     else:
        #         newbed = bed_file(fileout)
        #
        #     self.run(
        #         BEDTOOLS + "bedtools intersect -a " + self.filename + " -b " + other.filename + " > " + newbed.filename)
        #
        #     return newbed
        #

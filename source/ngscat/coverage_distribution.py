...
def main():
    ...
    ************************************************************************************************************************************************************
    ...
    parser.add_option("--bams", dest="bams",
                      help="""String containing a comma separated list of paths to the bam files.""")
    parser.add_option("--beds", dest="beds",
                      help="""String containing a comma separated list of paths to the bed files.""")
    parser.add_option("--dirout", dest="dirout",
                      help="""String containing the full path to the directory where results will be stored.""")
    parser.add_option("--labels", dest="labels",
                      help="""String containing a comma separated list of labels to name each sample (bam) in the graph.""")
    ...
    # call core function
    coverage_distribution(options.bams.split(','), options.beds.split(','), options.dirout, options.labels.split(','),
                          options.normalize == 'y')

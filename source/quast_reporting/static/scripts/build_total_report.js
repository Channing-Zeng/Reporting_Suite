...
(function() {
  ...
  get_metric_name_html = function(rec) {
    var metricName;
  ...
  reporting.buildCommonRecords = function(common_records) {
    ...
    if (common_records) {
      ...
      for (_i = 0, _len = common_records.length; _i < _len; _i++) {
        ...
        table += "\n<tr><td> <span class='metric_name'>" + (get_metric_name_html(rec)) + ":</span> " + rec.cell_contents + " </td></tr>";
      }
      table += "\n</table>\n";
  ...
  reporting.buildTotalReport = function(report, columnOrder) {
    ...
    for (recNum = _i = 0, _ref = report.sample_reports[0].records.length; 0 <= _ref ? _i < _ref : _i > _ref; recNum = 0 <= _ref ? ++_i : --_i) {
      ...
      table += "<td class='second_through_last_col_headers_td' position='" + pos + "'> " + (DRAGGABLE_COLUMNS ? '<span class=\'drag_handle\'><span class=\'drag_image\'></span></span>' : '') + " <span class='metricName'>" + (get_metric_name_html(rec)) + "</span> </td>";
    }

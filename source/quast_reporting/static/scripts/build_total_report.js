...
(function() {
  var GREEN_HSL, GREEN_HUE, RED_HUE, add_heatmap, css_property_to_color, get_color, get_qc_meta_tag_contents, metric, records, report,
  ...
  add_heatmap = function() {
    return $(".report_table td[number]").each(function() {
      var cell, k, max, maxHue, min, minHue, orther_numbers, other_cells, quality;
